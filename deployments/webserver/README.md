...
Module `sdkwork-forum` · runtime code `forum` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `forum-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `forum-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `forum-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `forum-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `forum.sdkwork.com` | 443 ssl + 80 |
