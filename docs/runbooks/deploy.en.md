# Runbook — sdkwork-forum deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-forum-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-forum/bundle`, loads the image, starts
